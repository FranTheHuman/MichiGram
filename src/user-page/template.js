        ...
        <div class="col s12 m10 offset-m1 l8 offset-l2 center-align heading">
            <div class="row">
                ...
                <div class="col s12 m10 offset-m1 l6 left-align">
                    ...
                    <p class="description left-align">${user.description}</p>
                </div>
            </div>
        </div>
            <div class="row">
                ${user.pictures.map(function (picture) {
                    return yo`<div class="col s12 m6 l4">
                        <a href="/${user.username}/${picture.id}" class="container-picture">
                        ...
                        <div id="modal${picture.id}"class="modal modal-fixed-footer">
	                        ...
	                        <div class="modal-footer">	
		                        <div class="modal-likes modal-action modal-close waves-effect btn btn-flat"><i class="fa fa-heart"></i>${translate('likes', { likes: picture.likes })}</div>					      
                            </div>
                        </div>
                </div>`;
                })}   
